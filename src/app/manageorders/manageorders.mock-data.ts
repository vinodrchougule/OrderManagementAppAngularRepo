...
// `items` is illustrative mock line-item data (View Order modal's Item Details grid);
// it isn't required to sum exactly to totalAmount.
export const MOCK_ORDERS: Order[] = [
  { orderId: 1001, orderDate: '2026-07-01', customerId: 501, customerName: 'Vibha Chougule', totalAmount: 2499.0, status: 'Delivered', items: [
    { itemId: 1, itemName: 'Test Item1', quantity: 2, unitPrice: 999.5, lineTotal: 1999.0 },
    { itemId: 2, itemName: 'Test Item2', quantity: 1, unitPrice: 500.0, lineTotal: 500.0 }
  ] },
  { orderId: 1002, orderDate: '2026-07-02', customerId: 502, customerName: 'Rohan Kulkarni', totalAmount: 899.5, status: 'Shipped', items: [
    { itemId: 2, itemName: 'Test Item2', quantity: 1, unitPrice: 899.5, lineTotal: 899.5 }
  ] },
